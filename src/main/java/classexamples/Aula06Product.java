...
public class Aula06Product {
	...
	public static void main(String[] args) {
		...
		ImportUtil.importGraphCSV(g1,"./src/main/java/graphs/Uforprod",CSVFormat.EDGE_LIST);
		...
		ImportUtil.importGraphCSV(g2,"./src/main/java/graphs/vforprod",CSVFormat.EDGE_LIST);
	    System.out.println("\nGrafo G2: ");
