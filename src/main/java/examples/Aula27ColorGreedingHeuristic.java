...
public class Aula27ColorGreedingHeuristic {
	...
	public static void main(String[] args) {
        ...
        manuallistV.add(MyJGraphTUtil.getVertexfromLabel(graphgml.vertexSet(),"7"));
        manuallistV.add(MyJGraphTUtil.getVertexfromLabel(graphgml.vertexSet(),"0"));
        manuallistV.add(MyJGraphTUtil.getVertexfromLabel(graphgml.vertexSet(),"1"));
        manuallistV.add(MyJGraphTUtil.getVertexfromLabel(graphgml.vertexSet(),"4"));
        manuallistV.add(MyJGraphTUtil.getVertexfromLabel(graphgml.vertexSet(),"3"));
        manuallistV.add(MyJGraphTUtil.getVertexfromLabel(graphgml.vertexSet(),"2"));
        manuallistV.add(MyJGraphTUtil.getVertexfromLabel(graphgml.vertexSet(),"6"));
        manuallistV.add(MyJGraphTUtil.getVertexfromLabel(graphgml.vertexSet(),"8"));
        manuallistV.add(MyJGraphTUtil.getVertexfromLabel(graphgml.vertexSet(),"9"));
        manuallistV.add(MyJGraphTUtil.getVertexfromLabel(graphgml.vertexSet(),"10"));
        manuallistV.add(MyJGraphTUtil.getVertexfromLabel(graphgml.vertexSet(),"5"));        
