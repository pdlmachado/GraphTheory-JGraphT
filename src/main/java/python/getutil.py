...
Este notebook contém funções que retornam diferentes informações sobre vértices e arestas (ou arcos) de um grafo. Inclui também funções que calculam propriedades como partições em um grafo bipartido.
